...
public class ResourcesManager {
    ...
    private BuildableBitmapTextureAtlas menuTextureAtlas, optionsTextureAtlas, aboutTextureAtlas, endGameTextureAtlas,
            recordTextureAtlas, gameTypeTextureAtlas, gameTextureAtlas, commonsTextureAtlas;
    // Commons
    private ITextureRegion backgroundCommonsTextureRegion;
    // Game
    ...
    public ITextureRegion getBackgroundCommonsTextureRegion() {
        return backgroundCommonsTextureRegion;
    }
    ...
    public void loadCommonResources() {
        if (commonsTextureAtlas != null) {
            commonsTextureAtlas.load();
            return;
        }

        BitmapTextureAtlasTextureRegionFactory.setAssetBasePath("gfx/common/");
        commonsTextureAtlas = new BuildableBitmapTextureAtlas(activity.getTextureManager(), 1024, 1024, TextureOptions.BILINEAR);

        backgroundCommonsTextureRegion = BitmapTextureAtlasTextureRegionFactory.createFromAsset(commonsTextureAtlas, activity, "background.jpg");

        try {
            commonsTextureAtlas.build(new BlackPawnTextureAtlasBuilder<IBitmapTextureAtlasSource, BitmapTextureAtlas>(0, 0, 1));
            commonsTextureAtlas.load();
        } catch (ITextureAtlasBuilder.TextureAtlasBuilderException e) {
            Log.e(TAG, "Error during building and loading atlas");
        }
